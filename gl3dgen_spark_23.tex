...
\label{sec:orgea607eb}

\subsection{State of research}
\label{sec:org8b48dcb}
\label{sec:research}
...
\label{sec:org604ea5a}


\subsubsection{Goals \& expected results}
\label{sec:org154d064}
\label{sec:goals}
...
these observations.\footnote{This could also be considered part of a follow-up project.}
\end{enumerate}

\subsubsection{Methods}
\label{sec:org4c40d1f}
\label{sec:methods}
...
\label{sec:org4847594}

The potential risks of this project mainly comprise of undesirable
outcomes which either impact the model's autonomy or extend the
project timeline due to additional work, but can be ameliorated:
\begin{itemize}[leftmargin=*, noitemsep]
...
\label{sec:orge177176}



\newpage
\section{Bibliography}
\label{sec:org2d64d63}
